...
/**
 * Single entry in the component image information that the UA will send to the FD.
 * 
 * Note that the values past comp_ver will be set during the firmware update process. 
 */
...
enum {
    ...
    CMD_HANDLER_PLDM_TRANSPORT_ERROR = CMD_HANDLER_PLDM_ERROR (0x06),                       /**< Transport level error. */
    CMD_HANDLER_PLDM_PROTOCOL_ERROR = CMD_HANDLER_PLDM_ERROR (0x07)                         /**< Protocol level error. */
};
