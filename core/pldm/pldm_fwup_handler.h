...
struct pldm_fwup_handler {
     ...
     * @return 0 if the update was successful otherwise an error code.
     */
    int (*start_update_fd) (struct pldm_fwup_handler *handler);
};
...
// Internal functions
int pldm_fwup_handler_generate_request(struct cmd_interface_pldm *intf, uint8_t command, uint8_t *buffer, size_t buf_len);
