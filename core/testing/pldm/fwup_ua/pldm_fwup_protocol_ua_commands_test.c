...
struct pldm_fwup_protocol_ua_commands_testing {
...
static void setup_testing(struct pldm_fwup_protocol_ua_commands_testing *testing, struct pldm_fwup_protocol_testing_ctx *testing_ctx, CuTest *test)
{
...
int send_and_receive_full_mctp_message(struct pldm_fwup_protocol_ua_commands_testing *testing, int command)
{
    int status;
...
static void release_testing(struct pldm_fwup_protocol_ua_commands_testing *testing) {
...
static void pldm_fwup_protocol_ua_commands_test_query_device_identifiers(CuTest *test) {
    ...
    struct pldm_fwup_protocol_ua_commands_testing testing;
    ...
    int status = send_and_receive_full_mctp_message(&testing, PLDM_QUERY_DEVICE_IDENTIFIERS);
    CuAssertIntEquals(test, 0, status);
