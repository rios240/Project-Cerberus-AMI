...
#define	MCTP_BASE_PROTOCOL_IS_SPDM_MSG(x)					(((x) & MCTP_BASE_PROTOCOL_MSG_TYPE_SET_MASK) == MCTP_BASE_PROTOCOL_MSG_TYPE_SPDM)
#define	MCTP_BASE_PROTOCOL_IS_VENDOR_MSG(x)					(((x) & MCTP_BASE_PROTOCOL_MSG_TYPE_SET_MASK) == MCTP_BASE_PROTOCOL_MSG_TYPE_VENDOR_DEF)
#define MCTP_BASE_PROTOCOL_IS_PLDM_MSG(x)					(((x) & MCTP_BASE_PROTOCOL_MSG_TYPE_SET_MASK) == MCTP_BASE_PROTOCOL_MSG_TYPE_PLDM)
