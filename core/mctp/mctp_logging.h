...
enum {
	...
	MCTP_LOGGING_MCTP_PLDM_RSP_FAIL,			/**< Failure while processing MCTP PLDM response message.*/
	MCTP_LOGGING_MCTP_PLDM_REQ_FAIL,			/**< Failure while processing MCTP PLDM request message.*/
};
